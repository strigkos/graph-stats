...
use GravityKit\GravityCharts\Foundation\Components\NewsletterSignup;
				...
				$general_settings = array_merge(
					...
					[
						...
						[
							...
							'type'        => 'select',
							'title'       => esc_html__( 'GravityKit Menu Position', 'gk-gravitycharts' ),
							'description' => esc_html__( 'Select the menu below which to place the GravityKit menu.', 'gk-gravitycharts' ),
						...
						[
							...
							'choices'     => $top_level_menu_action_choices,
							'title'       => esc_html__( 'GravityKit Menu Page', 'gk-gravitycharts' ),
							'description' => esc_html__( 'Select the page to open when clicking the GravityKit menu.', 'gk-gravitycharts' ),
						],
						[
							'id'          => 'powered_by',
							'type'        => 'checkbox',
