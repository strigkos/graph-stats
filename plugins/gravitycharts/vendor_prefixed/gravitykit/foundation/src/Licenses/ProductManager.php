...
use GravityKit\GravityCharts\Foundation\Helpers\WP;
...
class ProductManager {
	...
	public function ajax_delete_product( array $payload ): array {
		...
		if ( $product['active'] ) {
			throw new Exception(
				esc_html__( 'Product must be deactivated before it can be deleted.', 'gk-gravitycharts' )
			);
		}
        ...
        return [
            ...
            'ui_action' => [
                ...
                'redirect' => ! $backend_foundation_version ? [
                    ...
                    'loader_title'   => esc_html__( 'Redirecting to the Plugins page…', 'gk-gravitycharts' ),
                    'loader_message' => esc_html__( 'Manage Your Kit functionality is no longer available.', 'gk-gravitycharts' ),
                ] : false,
            ],
        ];
	}
